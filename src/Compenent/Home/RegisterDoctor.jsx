        ...
        <div className="container py-5">
          <div className="row gx-5">
            <div className="col-lg-6 mb-5 mb-lg-0">
              <div className="mb-4">
                <h5 className="d-inline-block text-white text-uppercase border-bottom border-5">Register DOCTOR</h5>
                <h1 className="display-4">Make An account </h1>
              </div>
              <p className="text-white mb-5"> you must create an account to make service of doctor </p>
